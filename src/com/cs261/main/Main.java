...
// This code takes the input stream and then outputs it to a csv file.
// However now does it within a thread so other code may be used.
// Also it will now run until an interrupt is used (Ctrl-C).
